...
//This page is styled by  'PropCat.css' in "src/SubCat1/PropCat.css"
import "./PropCat.css";
...
export default function PropCat() {
    return (
        <div className='cat1'><h1 className='rat1'>Select Your SubCategory</h1>
                    ...
                    {/* ApartmentIcon is imported from material-ui */}
                    ...
                    {/* TerrainIcon is imported from material-ui */}
                    ...
                    {/* ShoppingCartIcon is imported from material-ui */}
                    ...
                    {/* HouseSidingIcon is imported from material-ui */}
                    ...
                    {/* HouseIcon is imported from material-ui */}
                    ...
                    {/* LocalParkingIcon is imported from material-ui */}
                    ...
                    {/* The following code is responsible for the curve present in the bottom of the ' Property Subcategory' page (ie) "PropCat.js" */}

                    {/* The curve is styled by PropCat.css in "src/SubCat1/PropCat.css" */}
